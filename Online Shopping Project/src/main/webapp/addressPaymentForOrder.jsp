...
%>
          ...
          <th scope="col"><a href="myCart.jsp"><i class='fas fa-arrow-circle-left'> Back</i></a></th>
            <th scope="col" style="background-color: yellow;">Total: <i class="fa fa-usd"></i> <%out.println(total); %></th>
          </tr>
        </thead>
        <thead>
          <tr>
...
<div class="right-div">
<h3>Pay online on this rifat@pay.com</h3>
...
<div class="left-div">
<h3>Mobile Number</h3>
<input class="input-style" type="text" name="moblieNumber" value="<%=rs2.getString(3)%>" placeholder="Enter Your Number" required>
