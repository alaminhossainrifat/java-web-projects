...
<table id="customers">
          ...
          <th>Mobile Number</th>
            ...
            <th scope="col"><i class="fa fa-usd"></i> Sub Total</th>
            <th>Address</th>
            <th>City</th>
            <th>State</th>
            <th>Country</th>
        ...
        %>
          ...
          <td><%=rs.getString(10)%></td>
            ...
            <td><i class="fa fa-usd"></i><%=rs.getString(5)%></td>
             ...
             <td><%=rs.getString(11)%></td>
              <td><%=rs.getString(12)%></td>
               ...
               <td><a href="cancleOrdersAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Cancel <i class='fas fa-window-close'></i></a></td>
